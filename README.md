...
So far, the API is the basic task controlling stuff, no control about who is the task owner, as this is made as a personal project so far,
but I try to make this project easily escalable, and I will work on different users on the future.
Both the app/ and api/ directories have their own documentation, which you can read for further information about each of those parts.